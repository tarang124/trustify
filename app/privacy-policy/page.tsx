...
export const metadata: Metadata = {
  title: "Privacy Policy — Trustify",
  description:
    "Read the Trustify Privacy Policy to understand how we collect, use, and protect your personal data.",
}
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-4xl px-4 py-16 lg:px-8">
          ...
          {/* Content */}
          <article className="prose prose-invert max-w-none space-y-8 text-muted-foreground [&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-foreground [&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:text-foreground [&_h4]:mt-6 [&_h4]:mb-2 [&_h4]:text-lg [&_h4]:font-semibold [&_h4]:text-foreground [&_p]:leading-relaxed [&_ul]:space-y-2 [&_ul]:pl-6 [&_li]:leading-relaxed [&_strong]:text-foreground/90">
            <p>
            ...
            <ul className="list-disc">
              ...
              <li>
                <strong>Application</strong> refers to Affiliate Bot, the
                software program provided by the Company.
              </li>
              <li>
                <strong>Company</strong> (referred to as either &quot;the
                Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot;
                in this Privacy Policy) refers to Affiliate Bot.
              </li>
              <li>
            ...
            <ul className="list-disc">
              <li>
                ...
                retain specific data (e.g., financial records for tax
                authorities).
              </li>
              <li>
              ...
              <li>
                <strong>Technical limitations:</strong> Data exists in backup
            ...
            <ul className="list-disc">
              ...
              <li>
                ...
                encrypted backups for a limited period consistent with our
                backup retention schedule and are not restored except where
                necessary for security, disaster recovery, or legal compliance.
              </li>
              <li>
                <strong>Anonymization:</strong> In some cases, We convert
                Personal Data into anonymous statistical data that cannot be
                linked back to You. This anonymized data may be retained
            ...
            <ul className="list-disc">
              <li>
                By email:{" "}
                <a
                  href="mailto:tarang@trustify.top"
